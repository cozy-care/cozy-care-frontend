        ...
        <main className="flex min-h-[calc(100svh-3.5rem)]">
            ...
            <div className="flex w-[80%]">
                <div className="flex flex-col grow  border-r-1 border-gray-300">
                    ...
                    <div className="flex h-[64px] items-center justify-between px-2 gap-4  border-t-1 border-gray-300">
                ...
                {isVisible && (
                    <div className="w-[24%]">
                        <div className="flex flex-col px-2 pt-6">
                            <Image
                                alt="Chat profile"
                                className="object-center object-cover rounded-full border-2 border-red-100"
                                width={150}
                                height={'auto'}
